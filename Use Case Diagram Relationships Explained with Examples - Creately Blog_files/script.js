jQuery(function ($) {
    ...
    $this.adjustMenuHeight = function() {
      ...
      if( $(window).width() < 992 ){
        ...
        $('.main-menu ul li a').css('line-height',menuLineHeight + 'px');

        if ( menuLineHeight < 50 ) {
          $('.main-menu ul li a').css('fontSize', '1.4em');
        }
        else {
          $('.main-menu ul li a').css('fontSize', '1.8em');
        }
      } else {
        $('.main-menu ul li a').css('line-height', '2.15em');
        $('.main-menu ul li a').css('fontSize', '18px');
      }
    }
     ...
     */
    $(".search-form .explore-category").change(function() {
      $(".search-form").submit();
    });
